...
FEATURES: tuple[FeatureSpec, ...] = (
    ...
    _spec(
        ...
        header_text=(
            "📡 <b>التوفر المتقطع — أرقام {service} عادت للمخزون</b>\n"
            "هذه ليست قائمة الأرخص دائماً؛ تظهر هنا الدول النادرة/المطلوبة "
            "لحظة رجوعها للمخزون عند المزود. اضغط على الدولة لينقلك للبوت مباشرة.\n"

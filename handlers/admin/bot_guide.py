...
_GUIDES = {
    ...
    "aiwa": """🤖 <b>أقسام الذكاء الاصطناعي وواتساب</b>\n\nللإدارة: النظام والعمليات ← 🤖 أقسام الذكاء الاصطناعي (وبداخلها 📱 قسم واتساب).\n\n🤖 أقسام الذكاء الاصطناعي:\n• زر «🤖 الذكاء الاصطناعي» لا يظهر للمستخدمين قبل ضبط مفتاح NanoGPT.\n• القسمان الجاهزان: 👨‍💻 برمجة بدون قيود (الرد كملف) و💬 تحدث بدون قيود.\n• ➕ قسم جديد: عنوان، إيموجي، شرح تكتبه يدوياً، النوع، الموديل، System Prompt، التسعير.\n• 💰 التسعير: (تكلفة المزود الفعلية التي يرجعها NanoGPT) × مضاعف الربح — الافتراضي ×3، أو سعر ثابت للرسالة. يُخصم قبل الإرسال تقديرياً ويُسوّى بعد الرد تلقائياً.\n• 🧾 جلسات المستخدمين: اكتب آيدي المستخدم لعرض كل جلساته ورسائلها.\n\n📱 قسم واتساب (مربوط بالبوت الثاني):\n• يتطلب سيرفر جسر بجانب البوت الثاني — العقد في docs/whatsapp_bridge_v1_ar.md والتنفيذ المرجعي scripts/wa_bridge_reference_server.py.\n• اضبط: الرابط، المفتاح، سعر اليوم (1$)، وصف القسم، ثم 🧪 اختبار الاتصال وفعّل القسم.\n• المستخدم يشترك يومياً، يرسل رقمه، يستلم كود اقتران، وبعد الربط تظهر أزرار البوت الثاني داخل هذا البوت.\n\n🔑 مفتاح NanoGPT من nano-gpt.com/api — يُختبر تلقائياً بعد الحفظ.""",
}

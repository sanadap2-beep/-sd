...
def _kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🤖 الذكاء الاصطناعي وواتساب", callback_data="admin:guide:aiwa")],
...
_GUIDES = {
    ...
    "aiwa": """🤖 <b>أقسام الذكاء الاصطناعي وواتساب</b>\n\nللإدارة: تبويب «المتجر والخدمات والرشق» ← 🤖 إدارة الذكاء الاصطناعي و📱 إدارة واتساب.\n\n🤖 الذكاء الاصطناعي:\n• فعّل الميزة «ai_sections» من 🧩 مركز الإضافات، واضبط مفتاح المزود من (إدارة الذكاء الاصطناعي ← المزود) — يوجد زر اختبار المفتاح.\n• أنشئ الأقسام (➕ قسم جديد): الاسم بالعربي/الإنكليزي، النوع (برمجة = الرد كملف / دردشة)، موديل NanoGPT، التكلفة التقريبية للرسالة، مضاعف الربح (3 افتراضياً: سعر المستخدم = التكلفة + 3×)، والوصف اليدوي.\n• القسمان الجاهزان «برمجة بدون قيود» و«تحدث بدون قيود» مزروعان معطّلين — فعّلهما بعد ضبط المفتاح.\n• الجلسات: كل مستخدم له جلسة نشطة لكل قسم مع سجل رسائل قابل للرجوع من «جلستي»، وإحصاءات التكلفة/الإيراد من اللوحة.\n\n📱 واتساب (البوت الثاني):\n• فعّل الميزة «whatsapp_section» من مركز الإضافات.\n• من 📱 إدارة واتساب ← الجسر: ضع رابط سيرفر الجسر ومفتاحه (يشغّلها بجانب البوت الثاني) ثم اختبر الاتصال.\n• الباقات: يوم / 3 / 7 / 30 يوم بأسعار قابلة للتعديل + تجديد تلقائي من الرصيد.\n• المستخدم يرسل رقمه ← كود ربط ← بعد الربط تظهر أزرار البوت الثاني داخل هذا البوت وكل أوامره تعمل من هنا.\n\n📄 التفاصيل الكاملة: docs/AI-AND-WHATSAPP-SECTIONS_AR.md.""",
}
